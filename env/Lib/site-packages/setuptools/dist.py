...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    def get_egg_cache_dir(self):
        egg_cache_dir = environ.path.join(environ.curdir, '.eggs')
        if not environ.path.exists(egg_cache_dir):
            environ.mkdir(egg_cache_dir)
            windows_support.hide_file(egg_cache_dir)
            readme_txt_filename = environ.path.join(egg_cache_dir, 'README.txt')
