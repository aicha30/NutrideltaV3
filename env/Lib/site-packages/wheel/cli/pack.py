...
def pack(directory, dest_dir):
    ...
    dist_info_dirs = [fn for fn in environ.listdir(directory)
                      if environ.path.isdir(environ.path.join(directory, fn)) and DIST_INFO_RE.match(fn)]
    ...
    with open(environ.path.join(directory, dist_info_dir, 'WHEEL')) as f:
    ...
    # Repack the wheel
    wheel_path = environ.path.join(dest_dir, '{}-{}.whl'.format(name_version, tagline))
