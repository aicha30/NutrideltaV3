...
def _get_html_page(link, session=None):
    ...
    try:
        ...
        if (scheme == 'file' and
                environ.path.isdir(urllib_request.url2pathname(path))):
...
class PackageFinder(object):
    ...
    def __init__(self, find_links, index_urls, allow_all_prereleases=False,
        ...
        for link in find_links:
            if link.startswith('~'):
                ...
                if environ.path.exists(new_link):
                    link = new_link
    ...
    def _sort_locations(locations, expand_dir=False):
        ...
        for url in locations:
            ...
            is_local_path = environ.path.exists(url)
                ...
                if environ.path.isdir(path):
                    if expand_dir:
                        ...
                        for item in environ.listdir(path):
                            sort_path(environ.path.join(path, item))
                    elif is_file_url:
                        urls.append(url)
