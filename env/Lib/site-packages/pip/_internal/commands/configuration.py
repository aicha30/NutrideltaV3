...
class ConfigurationCommand(Command):
    ...
    def _determine_file(self, options, need_value):
        ...
        if sum(file_options.values()) == 0:
            ...
            elif environ.path.exists(venv_config_file):
                return kinds.VENV
            else:
                return kinds.USER
    ...
    def _determine_editor(self, options):
        ...
        elif "VISUAL" in environ.environ:
            return environ.environ["VISUAL"]
        elif "EDITOR" in environ.environ:
            return environ.environ["EDITOR"]
        else:
