...
class Configuration(object):
    ...
    def save(self):
        ...
        for fname, parser in self._modified_parsers:
            ...
            ensure_dir(environ.path.dirname(fname))
    ...
    def _load_config_files(self):
        ...
        if config_files[kinds.ENV][0:1] == [environ.devnull]:
            logger.debug(
    ...
    def _iter_config_files(self):
        ...
        config_file = environ.environ.get('PIP_CONFIG_FILE', None)
        ...
        should_load_user_config = not self.isolated and not (
                config_file and environ.path.exists(config_file)
        )
