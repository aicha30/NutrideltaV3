...
_UNIXCONFDIR = environ.environ.get('UNIXCONFDIR', '/etc')
...
class LinuxDistribution(object):
    ...
    def __init__(self,
        ...
        * :py:exc:`UnicodeError`: A data source has unexpected characters or
        ...
        self.os_release_file = os_release_file or \
                               environ.path.join(_UNIXCONFDIR, _OS_RELEASE_BASENAME)
    ...
    def _os_release_info(self):
        ...
        """
        if environ.path.isfile(self.os_release_file):
    ...
    def _lsb_release_info(self):
        ...
        if not self.include_lsb:
            return {}
        with open(environ.devnull, 'w') as devnull:
            try:
                cmd = ('lsb_release', '-a')
    ...
    def _distro_release_info(self):
        ...
        if self.distro_release_file:
            ...
            basename = environ.path.basename(self.distro_release_file)
            ...
            try:
                basenames = environ.listdir(_UNIXCONFDIR)
            ...
            for basename in basenames:
                ...
                match = _DISTRO_RELEASE_BASENAME_PATTERN.match(basename)
                if match:
                    filepath = environ.path.join(_UNIXCONFDIR, basename)
